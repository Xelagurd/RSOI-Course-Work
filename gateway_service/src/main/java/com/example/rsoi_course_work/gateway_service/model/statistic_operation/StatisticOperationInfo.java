package com.example.rsoi_course_work.gateway_service.model.statistic_operation;

import java.util.Date;
import java.util.Objects;
import java.util.UUID;

public class StatisticOperationInfo {
    ...
    public StatisticOperationInfo() {
    }

    public StatisticOperationInfo(UUID statistic_operation_uid, ServiceType service_type, StatisticOperationType statistic_operation_type, Date date, UUID user_uid, UUID scooter_uid, UUID located_scooter_uid, UUID rental_station_uid, UUID rental_uid, UUID payment_uid) {
    ...
    public boolean equals(Object o) {
        ...
        StatisticOperationInfo that = (StatisticOperationInfo) o;
    ...
    @Override
    public int hashCode() {
        int result = statistic_operation_uid != null ? statistic_operation_uid.hashCode() : 0;
